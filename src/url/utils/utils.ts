...
/**
 * Normalizes a protocol/scheme string for URL construction and comparison.
 *
 * Strips a trailing colon and optional slashes, then lowercases the result:
 * `http`, `http:`, and `http://` all normalize to `http`.
 *
 * @param protocol - Protocol or scheme value to normalize.
 * @returns Lowercase protocol without a trailing colon or slashes.
 */
